  ...
  Plugin.prototype = {
    ...
    getSingle: function (key, comp, value, ...cols) {
      if (arguments.length === 0) {
        return console.warn("Aucune clef de recherche pour la requête");
      }
    ...
    getCollection: function (key, comp, value, ...cols) {
      if (arguments.length < 3) {
        return console.warn(
          "Il faut une clef, un operateur et une valeur pour créer une collection.",
        );
      }
      if (arguments.length >= 3) {
